...
export const papers: Paper[] = [
  {
    ...
    subtitle: 'What changes when a familiar image is given more time?', excerpt: 'A sample paper about resisting the first, easiest version of a story.',
    topic: 'Representation', publishedAt: '2026-06-02T12:00:00Z', readingTime: '7 min read', audioDuration: '8 min audio', image: '/editorial/paper-study.jpg', views: 0, reactions: 0, status: 'published', sample: true,
    body: [
      { text: 'This is sample editorial content created to demonstrate the reading experience. It does not represent a published claim or a completed paper by Daniel Koo.' },
      { heading: 'The first image is rarely the whole image' },
      { text: 'Distance makes clean outlines. Real places are harder to hold: contradictory, ordinary, intimate, and always changing beneath the names used to describe them.' },
      { quote: 'To look twice is to leave room for another person’s reality.' },
      { heading: 'A practice of attention' },
      { text: 'K-VERSATION is designed for that second look. The finished paper can include citations, footnotes, audio narration, images, and a downloadable PDF.' }
    ]
  },
  {
    id: 'sample-paper-02', slug: 'the-shape-of-an-inherited-question', title: 'The Shape of an Inherited Question',
    subtitle: 'Identity is not a conclusion. It is a method of asking.', excerpt: 'Sample writing on heritage, uncertainty, and the questions passed between generations.',
    topic: 'Identity', publishedAt: '2026-04-20T12:00:00Z', readingTime: '9 min read', image: '/editorial/bridge.jpg', views: 0, reactions: 0, status: 'published', sample: true,
    body: [{ text: 'Sample paper. Replace this text through the host dashboard before publication.' }]
  },
  {
    id: 'sample-paper-03', slug: 'beyond-the-exported-story', title: 'Beyond the Exported Story',
    subtitle: 'Culture travels quickly. Context travels more slowly.', excerpt: 'A sample essay structure about international attention and the details that resist packaging.',
    topic: 'Culture', publishedAt: '2026-02-11T12:00:00Z', readingTime: '6 min read', image: '/editorial/exchange.jpg', views: 0, reactions: 0, status: 'published', sample: true,
    body: [{ text: 'Sample paper. Replace this text through the host dashboard before publication.' }]
  }
]
