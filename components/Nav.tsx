...
export default function Nav() {
  ...
  return <><header className="site-header">
    ...
    <div className="nav-left"><nav className="nav-desktop" aria-label="Primary">
    ...
    <div className="nav-actions"><Link className="nav-subscribe" href="/join" onClick={()=>setOpen(false)}>Join / Subscribe</Link><button className="menu-trigger" aria-expanded={open} aria-controls="mobile-menu" onClick={() => setOpen(v => !v)}><span>{open ? 'Close' : 'Menu'}</span><i /></button></div>
  </header>
