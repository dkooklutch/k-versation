...
const display = localFont({ src: [{ path: './fonts/manrope-regular.ttf', weight: '400' }, { path: './fonts/manrope-bold.ttf', weight: '700' }], variable: '--font-display', display: 'swap' })
...
export const viewport: Viewport = { width: 'device-width', initialScale: 1, themeColor: '#161512' }
